...
function makeFrequency () {
    ...
    Frequency.prototype.on = function on (evt, fn) {
        // TODO check evt and fn
        // TODO check max listeners number
        ee.on(evt, fn)
    }

    Frequency.prototype.once = function once (evt, fn) {
        // TODO check evt and fn
        // TODO check max listeners number
        ee.once(evt, fn)
    }

    Frequency.prototype.off = function (fn) {
        // TODO check fn
        ee.removeListener(fn) // ee.removeAllListeners([etv]) ??? Bad practice
    }

    Frequency.prototype.emit = function emit (evt, data) {
